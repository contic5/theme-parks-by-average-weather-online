...
## About
This project analyzes the heat index for different theme parks throughout the year. It creates monthly charts based on averaged heat and humdiity values.
